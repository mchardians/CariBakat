<x-landing-layout title="Detail Pekerjaan">
    <x-slot name="content">
        <!-- HOME -->
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="custom-breadcrumbs">
                            ...
                            <a href="{{ route('home') . '#jobs' }}">Pekerjaan</a> <span class="mx-2 slash">/</span>
                ...
                <div class="row align-items-center mb-5">
                    <div class="col-lg-8 mb-4 mb-lg-0">
                        <div class="d-flex align-items-center">
                            <div class="border p-2 d-inline-block mr-3 rounded">
                                <img src="{{ asset('assets/landing/images/job_logo_5.jpg') }}" alt="Image">
                            </div>
                            <div>
                                ...
                                <div>
                                    ...
                                    <span class="m-2"><span class="icon-clock-o mr-2"></span><span
                                            class="text-primary">Full Time</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <a href="{{ route('job-apply') }}" class="btn btn-block btn-primary btn-md">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="mb-5">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis illum fuga eveniet.
                                ...
                                nemo blanditiis iste eius officia minus.</p>
                            <p>Velit unde aliquam et voluptas reiciendis non sapiente labore, deleniti asperiores
                        ...
                        <div class="mb-5">
                            ...
                            <ul class="list-unstyled m-0 p-0">
                                ...
                                <li class="d-flex align-items-start mb-2"><span
                                        ...
                                        labore</span></li>
                                <li class="d-flex align-items-start mb-2"><span
                                        class="icon-check_circle mr-2 text-muted"></span><span>Commodi quae ipsum quas
                                        est itaque</span></li>
                                <li class="d-flex align-items-start mb-2"><span
                                        class="icon-check_circle mr-2 text-muted"></span><span>Lorem ipsum dolor sit
                                        amet, consectetur adipisicing elit</span></li>
                                <li class="d-flex align-items-start mb-2"><span
                    ...
                    <div class="col-lg-4">
                        <div class="bg-light p-3 border rounded mb-4">
                            ...
                            <ul class="list-unstyled pl-3 mb-0">
                                <li class="mb-2"><strong class="text-black">Published on:</strong> April 14, 2019
                                </li>
                                <li class="mb-2"><strong class="text-black">Vacancy:</strong> 20</li>
                                <li class="mb-2"><strong class="text-black">Employment Status:</strong> Full-time
                                </li>
