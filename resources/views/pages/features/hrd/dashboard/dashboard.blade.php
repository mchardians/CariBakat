        ...
        <div class="page-inner mt--5">
            <div class="row row-card-no-pd align-items-center p-2 p-sm-4">
                <div class="col-lg-2 mb-4 mb-lg-0">
                    <img src="{{ asset('assets/template/img/welcome-image.png') }}" alt="welcome image"
                        class="img-fluid d-block mx-auto" width="170">
                </div>
                <div class="col-lg-10 heroes-text px-xl-5">
